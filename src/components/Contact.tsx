        ...
        <div className='flex justify-center items-center'>
            <ul className='space-y-4'>
                <li className='flex items-center'>
                    ...
                    <p className='text-x1'>+62 852-1550-5960</p>
                </li>
                <li className='flex items-center'>
                    <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6'/>
                    <p className='text-x1'>rizq.syafriano@gmail.com</p>
                </li>
            </ul>
        </div>

        <div className='bg-white/10 p-6 rounded-x1 max-w-[550px]'> 
        <h2 className='text-5x1 font-bold text-orange-400 mb-4'>Let's connect</h2>
        <p className='text-white/70 mb-6'>Send me message and lets schedule a call!</p>
        <form className='space-y-4' action="https://getform.io/f/aroomydb" method='POST'>
            <div className='grid md:grid-cols-2 gap-4'>
                ...
                <input type='txt'  name='name'  className='bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Last Name' />
